...
public class CustomRocksDBConfig implements RocksDBConfigSetter{
    ...
    private static final long INDEX_FILTER_MEMORY = (1)*1048576L;//DataSize.ofMegabytes(50).toBytes();
    ...
    public void setConfig(String storeName, Options options, Map<String, Object> configs) {
        ...
        System.out.println("configuring new Javis rocksdb configuration");
